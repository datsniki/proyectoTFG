...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 23-05-2021 a las 15:20:23
...
--
CREATE DATABASE IF NOT EXISTS `kratosgym1` DEFAULT CHARACTER SET utf8mb4 COLLATE utf8mb4_general_ci;
USE `kratosgym1`;
...
CREATE TABLE `usuarios` (
  ...
  `fecha` date NOT NULL,
  `imagenperfil` varchar(250) NOT NULL DEFAULT 'activos\\img\\usuarios\\default\\default.png'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
--
ALTER TABLE `usuario_ejercicio`
  MODIFY `codigoUE` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=132;
