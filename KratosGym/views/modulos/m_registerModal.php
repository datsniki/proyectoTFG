                ...
                <div class="modal-body">
                    <section>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-lg-4">
                                <label for="dni">DNI *
                                    <span id="dniAlert" style="font-size: 0.8em; color: red;"></span>
                                </label>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-lg-4">
                                <label for="telefono">Telefono *
                                    <span id="telfAlert" style="font-size: 0.8em; color: red;"></span>
                                </label>
                        ...
                        <div class="form-row">
                            ...
                            <div class="form-group col-lg-7">
                                <label for="password">Contraseña *
                                    <span id="passAlert" style="font-size: 0.8em; color: red;"></span>
                                </label>
                                <input type="password" required pattern="(?=\w*\d)(?=\w*[A-Z])(?=\w*[a-z])\S{8,16}" class="form-control" id="password" name="password" placeholder="Contraseña">
                            </div>
                        </div>
                    </section>
                    <section>
                        <hr>
                        <h6><b>Cuotas: </b><span id="passAlert" style="font-size: 0.8em; color: red;">Seleccione 1 Para continuar</span></h6>
                        <hr>
                        ...
                        <div class="form-row">
                            <div class="form-group col-lg-12">
                                <label for="iban">Numero de Cuenta - IBAN *
                                    <span id="ibanAlert" style="font-size: 0.8em; color: red;"></span>
                                </label>
