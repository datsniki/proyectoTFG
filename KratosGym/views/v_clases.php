<main class="body">
    ...
    //Comprobamos que haya alguna clase ya creada
    if ($filas == 0) {
    ?>
            ...
            ?>
                    <form action="" method="POST">
                        <div class="card m-4" style="width: 18rem;">
                            <?php
                            //Recuento de las personas apuntadas a la clase
                            ...
                            //Vemos si el usuario logeado está apuntado a la clase y ponemos el boton Apuntar o Desapuntar
                            ...
                            <div class="card-body">
                                ...
                                <p class="card-text">
                                    ...
                                    //sumo 1 día
                                    echo "<b>Fecha</b>: " . date("d-m-Y", strtotime($fecha_actual . "+ 1 days"));
                                    ?>
                                </p>
                            </div>
                        </div>
