            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="h5 navbar-nav ml-auto">
                        ...
                        <li class="pl-5 nav-item text-right">
                            <!-- <a class="nav-link text-dark btn btn-light" href="#"><b>Iniciar Sesion</b></a> -->
                            <a class="btn btn-light" href="views/v_login.php"><b>Iniciar Sesion</b></a>
                        </li>
                    </ul>
                </div>
            </div>
            ...
            <div class="container">
                ...
                <div class="collapse navbar-collapse" id="navbarResponsive">
                    <ul class="h5 navbar-nav ml-auto">
                        ...
                        <li class="pl-4 nav-item text-right">
                            <!-- Icono User -->
                            <a href="#" class="fa fa-user fa-2x text-light"></a>
