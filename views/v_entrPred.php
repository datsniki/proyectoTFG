<main class="body">
    ...
    //Comprobamos si existe un entrenamiento con ese codigo
    $consulta1 = mysqli_query($conexion, "SELECT * FROM entrenamientos WHERE cod_entrenamiento=$codEntrenamiento");
        ...
        <div class="container my-4">
            <div class="row">
                <div class="col-lg-3 col-md-4">
                    <?php
                    $datos = mysqli_fetch_assoc($consulta1);
                    ?>
                ...
                <div class="col-lg-9 col-md-8">
                    ...
                    ?>
                        <div class="d-flex justify-content-center align-items-center h-100 flex-column">
                            ...
                            <h1 class="text-secondary text-center">Este entrenamiento no tiene ejercicios actualmente</h1>
    ...
    ?>
<?php
        //Si no existe el entrenamiento mostramos:
    } else {
?>
    <div class="d-flex justify-content-center align-items-center h-100 flex-column">
        <img src="activos/img/index/logob.png" alt="">
        <h1 class="text-secondary text-center">Este entrenamiento no está disponible actualmente</h1>
        <a href="index.php" class="btn btn-dark">Volver al Inicio</a>
    </div>
<?php
    }
