<nav class="header shadow navbar navbar-expand-lg navbar-dark bg-dark">
    <div class="container">
        ...
        <div class="collapse navbar-collapse" id="navbarResponsive">
            <ul class="h5 navbar-nav ml-auto">
                ...
                <?php
                //Mostramos las secciones Clases y Entrenamientos cuando se loguee el usuario
                ...
                <?php
                // Si esta logeado el usuario mostramos el icono del perfil y log out
                if (isset($_SESSION['usuario'])) {
                ?>
                    <li class="pl-4 py-2 nav-item text-right">
                        <!-- Icono User -->
                ...
                <?php
                    // Si no esta logeado mostramos Iniciar Sesion y Resgistro 
                } else {
                ?>
