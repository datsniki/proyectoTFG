                            ...
                            <div class="form-row">
                                <div class="form-group col-lg-6">
                                    ...
                                    <select class="form-control" name="cuotaU" id="cuotaU">
                                        <?php
                                        // Creamos las opciones con las cuotas disponibles
                                        ...
                                        if ($numRow != 0) {
                                            for ($cont = 1; $cont < $numRow + 1; $cont++) {
                                                ...
                                                if (!$consulta == NULL) { //Si hay datos con el codigo los mostramos en la tabla
                                                    ...
                                                    //Marcamos selected la cuota del usuario
                                                    $selected = $query["cod_cuota"] == $cont ? "selected" : "";
                                                    echo "<option $selected value='$cont'>$name - $cuota[precio]€ </option>";
                                                } else {
                                                    $numRow++;
                                                }
                                            }
                                        } else {
                                            echo  '<option value="">No hay Cuotas</option>';
                                        }
