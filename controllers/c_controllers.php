...
Se llamará a la funcion de subir imagen si sube algún archivo
...
if (isset($_POST['actualizar'])) {
    ...
    if (comprobarCredenciales($conexion, $usuario, $_POST['passU'])) {
        ...
        if ($cuota != "") {
            ...
            $actualizar = "UPDATE usuarios SET cod_cuota = NULL, nombre = '$nombre', apellidos = '$apellidos', pass ='$newPassword', iban = '$iban', direccion = '$direccion', imagenperfil = '$image', codpostal = '$cpostal'  WHERE cod_usuario = '$_SESSION[codusu]'";
        }
