...
--
-- Servidor: 127.0.0.1
-- Tiempo de generación: 18-05-2021 a las 20:08:19
...
(1, 'mensual', 239.99, 'Un unico pago. Equivalencia 19,99€ mensuales', 'activos\\img\\cuotas\\anual.png'),
(2, 'mensual', 29.99, 'Pago Mensual. ', 'activos\\img\\cuotas\\mensual.png'),
(3, 'diaria', 13.99, 'Pago en recepción por dia.', 'activos\\img\\cuotas\\diaria.png');
...
CREATE TABLE `entrenamientos` (
  ...
  `imagen` varchar(150) NOT NULL DEFAULT 'activos\\img\\default.png'
) ENGINE=InnoDB DEFAULT CHARSET=utf8mb4;
...
(1, 'Inferior', 'Entrenamiento dedicado para la parte inferior del cuerpo', 'activos\\img\\entr1.png'),
(2, 'Superior', 'Entrenamiento dedicado para la parte superior del cuerpo', 'activos\\img\\entr2.png'),
(3, 'Full Body', 'Entrenamiento general para todo el cuerpo', 'activos\\img\\entr3.png');
...
--
ALTER TABLE `usuario_ejercicio`
  MODIFY `codigoUE` int(11) NOT NULL AUTO_INCREMENT, AUTO_INCREMENT=95;
