<main class="body container ">
    ...
    <div class="my-4 contacto">
        ...
        <div class="contactanos bg-dark">
            <h3 class="font-weight-bold">Si quieres más informacion <br> ponte en contacto con nosotros</h3>
            <form action="" method="POST">
                <input class="form-control-lg w-100 m-1" required placeholder="Nombre y Apellidos" type="text"><br>
                <input class="form-control-lg w-100 m-1" required placeholder="Mail" type="email"><br>
                <input class="form-control-lg w-100 m-1" required placeholder="Teléfono" type="tel" pattern="[0-9]{9}"><br>
                <textarea rows="5" style="height:100%;" class="form-control-lg w-100 m-1" required placeholder="¿Que te interesa?" type="text"></textarea><br><br>
