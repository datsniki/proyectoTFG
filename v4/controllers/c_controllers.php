...
if (isset($_POST['actualizar'])) {
    ...
    if (comprobarCredenciales($conexion, $usuario, $_POST['password'])) {
        $actualizar = "UPDATE usuarios SET nombre = '$nombre', apellidos = '$apellidos', usuario ='$usuario', pass ='$password', correo = '$correo'  WHERE cod_usuario = '$_SESSION[codusu]'";
